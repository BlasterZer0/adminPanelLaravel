...
<div class="container text-center">
    ...
    @endif
        ...
        <div class="row mb-3">
            <label for="address" class="col-md-2 col-form-label text-md-start">{{ __('Dirección') }}</label>
            
            <div class="col-md-10">
                <input type="text" name="address" class="form-control" placeholder="Dirección" value="{{ old('address') ?? @$user->address}}">
